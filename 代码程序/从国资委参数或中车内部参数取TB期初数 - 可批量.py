...
filearray=[]
filelocation=glob.glob(r"D:\2021年度审计\TB模板\中车内部参数报表导出\*XLS") #上年参数所在文件夹
for filename in filelocation:
    ...
    wb2=app.books.open(r'D:\2021年度审计\TB模板\TB（CRRC00-中国中车） -1116.xls')  #TB模板位置
    sht2 = wb2.sheets["封面"]
    sht2.range(3, 2).value = name2
    ...
    wb2.save(r'D:\2021年度审计\TB模板\中车TB\TB(CRRC00-{}211231).xls'.format(name2)) #新生成的TB位置及命名方式
    wb2.close()
    wb1.close()
app.quit()
