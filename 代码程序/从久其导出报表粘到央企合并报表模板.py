...
wb2=app.books.open(r'E:\报表模板\合并报表模板.xlsx') #TB模板位置


# 合并报表工作簿，母公司工作簿在256行输入
wb1 = app.books.open(r'E:\久其导表\合并表\科技园合并久其TB.XLS')
sht1 = wb1.sheets["FMDM 封面代码"]
sht2 = wb2.sheets["合并资产负债表"]
...
wb1.close()
wb1 = app.books.open(r'E:\久其导表\合并表\科技园单体久其TB.XLS')
sht2 = wb2.sheets["母公司资产负债表"]
sht1 = wb1.sheets["Z01 资产负债表(企财01表)"]
...
wb2.save(r"E:\生成报表\2-{}2021年度财务报表.xlsx".format(name))
wb2.close()
wb1.close()
